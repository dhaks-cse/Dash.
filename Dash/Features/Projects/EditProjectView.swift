...
struct EditProjectView: View {
            ...
            VStack(spacing:0){
                ...
                ScrollView{
                    ...
                    VStack(spacing:14){
                        ...
                        section("Status","checkmark.circle")
    ...
    var completionField: some View{

        VStack(spacing:12){

            Toggle("Payment Done",isOn:$project.isPaymentDone)
                .tint(.purple)

            Toggle("Project Completed",isOn:$project.isProjectCompleted)
                .tint(.purple)
        }
        .padding(14)
        .background(card)
